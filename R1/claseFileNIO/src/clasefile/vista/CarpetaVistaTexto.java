...
public class CarpetaVistaTexto implements InterfazVista{
    ...
    private void solicitaOperacion() {
        ...
        System.out.println("8: mueve archivo indicando ruta nueva");
        System.out.println("9: mostrar contenido de un directorio");
        System.out.println("10: eliminar directorios y archivos");
    ...
    private void procesaNuevaOperacion() {
        ...
        switch (operacion) {
            ...
            case 5 -> controladorA.actionPerformed(new ActionEvent(this, operacion, ELIMINARARCHIVO));
            ...
            case 8 -> controladorA.actionPerformed(new ActionEvent(this, operacion, MOVERARCHIVO));
            case 9 -> controlador.actionPerformed(new ActionEvent(this, operacion, MUESTRATODO));
            case 10 -> controlador.actionPerformed(new ActionEvent(this, operacion, BORRATODO));
